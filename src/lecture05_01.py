...
import cv2
import os
from my_module.K21999.lecture05_camera_image_capture import MyVideoCapture  # ← 学籍番号に合わせる
...
def lecture05_01():
    ...
    # ---- 保存処理（main.py のあるフォルダに output_image）----
    output_dir = os.path.join(os.getcwd(), "output_image")  # 実行ディレクトリ基準！
    os.makedirs(output_dir, exist_ok=True)
    output_path = os.path.join(output_dir, "lecture05_01_k24082.png")
